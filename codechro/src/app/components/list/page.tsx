    ...
    <div className="animate-fadeIn">
      <div className="mt-5">
        ...
        <div className="flex justify-center gap-5 items-center">
          <button className="border border-neutral-950 rounded-sm py-2 px-3" onClick={handlePrevious}
          disabled={startIndex === 0}>left</button>
          <button onClick={handleNext}
          disabled={startIndex + itemsPerPage >= posts.length} className="border border-neutral-950 rounded-sm  py-2 px-3">right</button>
        </div>
      </div>
    </div>
  )
